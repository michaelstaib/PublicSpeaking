...
namespace Client
{
    ...
    public partial class ReceiveMessagesResultParser
        : JsonResultParserBase<IReceiveMessages>
    {
        ...
        public ReceiveMessagesResultParser(IValueSerializerCollection serializerResolver)
        {
        ...
        protected override IReceiveMessages ParserData(JsonElement data)
        {
            return new ReceiveMessages
            (
                ParseReceiveMessagesMessage(data, "message")
            );

        }

        private global::Client.IMessage ParseReceiveMessagesMessage(
            JsonElement parent,
            string field)
        {
            ...
            (
                ...
                ParseReceiveMessagesMessageRecipient(obj, "recipient"),
                ParseReceiveMessagesMessageSender(obj, "sender"),
                DeserializeDateTime(obj, "sent"),
                DeserializeString(obj, "text")
            );
        }

        private global::Client.IParticipant ParseReceiveMessagesMessageRecipient(
            JsonElement parent,
            string field)
        {
            JsonElement obj = parent.GetProperty(field);
        ...
        private global::Client.IParticipant ParseReceiveMessagesMessageSender(
            JsonElement parent,
            string field)
        {
            JsonElement obj = parent.GetProperty(field);
