...
namespace Client
{
        ...
        : IChatClient
    {
        ...
        public global::System.Threading.Tasks.Task<global::StrawberryShake.IResponseStream<global::Client.IOnReceiveMessages>> OnReceiveMessagesAsync(
            global::System.Threading.CancellationToken cancellationToken = default)
        {

            return _streamExecutor.ExecuteAsync(
                new OnReceiveMessagesOperation(),
                cancellationToken);
        }

        public global::System.Threading.Tasks.Task<global::StrawberryShake.IResponseStream<global::Client.IOnReceiveMessages>> OnReceiveMessagesAsync(
            OnReceiveMessagesOperation operation,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            if (operation is null)
            {
